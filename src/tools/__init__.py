...
💡 LLM이 이 도구를 사용해야 하는 경우:
- "XXX 비급여 항목 코드의 분류 체계 알려줘" → 계층 구조 확인
...
💡 LLM이 이 도구를 사용해야 하는 경우:
- "2024년 1월 1일에 XXX 코드 사용 가능해?" → 날짜별 유효성 확인
- 코드의 유효기간이 궁금할 때
...
💡 LLM이 이 도구를 사용해야 하는 경우:
- "서울에서 XXX 비급여 항목 제공하는 병원 찾아줘" → 지역별 병원 검색
...
💡 LLM이 이 도구를 사용해야 하는 경우:
- "서울대병원에서 XXX 비급여 항목 가격 범위 알려줘" → 특정 병원 가격 확인
...
💡 LLM이 이 도구를 사용해야 하는 경우:
- "서울 강남구에서 XXX 비급여 항목 가장 저렴한 병원" → 지역별 가격 비교
...
💡 LLM이 이 도구를 사용해야 하는 경우:
- "XXX 비급여 항목 지역별 가격 통계 알려줘" → 전국 지역별 통계
...
- "XXX 비급여 항목 병원 유형별 가격 통계" → 유형별 가격 정보
...
💡 LLM이 이 도구를 사용해야 하는 경우:
- "XXX 비급여 항목에 대해 자세히 설명해줘" → 종합 정보 제공
